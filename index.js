...
//     return res.status(401).send({ message: "Moderator access only" });
//   }
//   next();
// };
...
// 		app.get('/applications/moderator',
//   verifyToken,
//   verifyModerator,
//   async (req, res) => {
//     try {
...
// 		app.get('/applications/details/:id',
// 			verifyToken,
// 			verifyModerator,
// 			async (req, res) => {
...
//       { _id: new ObjectId(req.params.id) },
//       { $set: { applicationFeedback: req.body.feedback } }
//     )
...
app.patch('/applications/:id/feedback',
  verifyToken,
  verifyModerator,
  async (req, res) => {
    try {
